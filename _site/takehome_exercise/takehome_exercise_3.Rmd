...
To combine the multiple sheets used to store *ParticipantStatusLogs*, we use the following [method 1](https://www.statology.org/r-merge-csv-files/) or [method 2](https://stackoverflow.com/questions/30242065/trying-to-merge-multiple-csv-files-in-r). 

...
# Further Exploratory Chart

I think the most interesting thing to understand here is what determines whether or not one has kids. To do that, I will like to draw a regression line. 

The factors I will like to compare against are *educationLevel*, *interestGroup* and *joviality.* 

**haveKids vs educationLevel**
```{r echo = FALSE}
ggplot(data = participant_data, 
       aes(x = educationLevel,
           colour = haveKids)) + 
